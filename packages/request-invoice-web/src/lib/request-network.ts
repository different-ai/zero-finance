 ...
 */
export async function createInvoiceRequest(data: InvoiceRequestData) {
  try {
    // Log request data
    ...
    console.log('0xHypr KEY-DEBUG', '--- CREATOR AND VIEWER KEYS GENERATION ---');
    console.log('0xHypr KEY-DEBUG', 'Creator wallet address:', wallet.address);
    console.log('0xHypr KEY-DEBUG', 'Creator private key (actual):', wallet.privateKey);
    console.log('0xHypr KEY-DEBUG', 'Creator private key (without 0x):', wallet.privateKey.substring(2));
    console.log('0xHypr KEY-DEBUG', 'Creator public key:', wallet.publicKey);
    console.log('0xHypr KEY-DEBUG', 'Viewer wallet address:', viewerWallet.address);
    console.log('0xHypr KEY-DEBUG', 'Viewer private key (actual):', viewerWallet.privateKey);
    console.log('0xHypr KEY-DEBUG', 'Viewer private key (without 0x):', viewerWallet.privateKey.substring(2));
    console.log('0xHypr KEY-DEBUG', 'Viewer public key:', viewerWallet.publicKey);
    ...
    console.log('0xHypr KEY-DEBUG', '--- Creating encrypted request with keys:');
    console.log('0xHypr KEY-DEBUG', 'Creator wallet address:', wallet.address);
    console.log('0xHypr KEY-DEBUG', 'Creator private key:', wallet.privateKey);
    console.log('0xHypr KEY-DEBUG', 'Creator public key:', wallet.publicKey);
    console.log('0xHypr KEY-DEBUG', 'Viewer wallet address:', viewerWallet.address);
    console.log('0xHypr KEY-DEBUG', 'Viewer private key:', viewerWallet.privateKey);
    console.log('0xHypr KEY-DEBUG', 'Viewer public key:', viewerWallet.publicKey);
