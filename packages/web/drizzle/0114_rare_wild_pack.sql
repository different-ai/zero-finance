...
CREATE INDEX "bridge_transactions_user_did_idx" ON "bridge_transactions" USING btree ("user_did");--> statement-breakpoint
CREATE INDEX "bridge_transactions_status_idx" ON "bridge_transactions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "bridge_transactions_deposit_tx_hash_idx" ON "bridge_transactions" USING btree ("deposit_tx_hash");--> statement-breakpoint
CREATE INDEX "bridge_transactions_created_at_idx" ON "bridge_transactions" USING btree ("created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "workspace_feature_unique_idx" ON "workspace_features" USING btree ("workspace_id","feature_name");--> statement-breakpoint
CREATE INDEX "workspace_features_workspace_id_idx" ON "workspace_features" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "workspace_features_feature_name_idx" ON "workspace_features" USING btree ("feature_name");--> statement-breakpoint
CREATE INDEX "workspace_features_is_active_idx" ON "workspace_features" USING btree ("is_active");--> statement-breakpoint
