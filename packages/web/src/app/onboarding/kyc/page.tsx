  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="w-full bg-white border border-[#101010]/10 rounded-[12px] shadow-[0_2px_8px_rgba(16,16,16,0.04)] overflow-hidden">
          <CardHeader className="p-5 sm:p-6 border-b border-[#101010]/10">
            ...
            <CardDescription className="text-[14px] text-[#101010]/70 mt-2">
              ...
              regulations, we need to verify your identity. This process is
              handled by our trusted partner, Align.
            </CardDescription>
          </CardHeader>
      ...
      <div className="lg:col-span-1">
        <Card className="w-full bg-white border border-[#101010]/10 rounded-[12px] shadow-[0_2px_8px_rgba(16,16,16,0.04)] sticky top-6">
          <CardHeader className="p-5 border-b border-[#101010]/10">
          ...
          <CardContent className="p-5 max-h-[calc(100vh-200px)] overflow-y-auto">
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="address">
                ...
                <AccordionContent className="text-sm text-[#101010]/70 space-y-2">
                  <p className="font-medium">What it is</p>
                  <p>
                    Your operating or HQ street address. You can use your
                    mailing address if that is how your company receives mail.
                  </p>
                  <p className="font-medium mt-2">Note</p>
                  <p>
                    Many KYB providers do not accept a registered agent address
                    as the operating address.
                  </p>
