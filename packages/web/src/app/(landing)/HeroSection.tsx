  ...
  return (
    <>
      ...
      <section className="border-b border-[#101010]/10 bg-[#F6F5EF] [background-image:radial-gradient(rgba(0,0,0,0.03)_1px,transparent_1px)] [background-size:3px_3px]">
        <div className="mx-auto max-w-[1200px] px-8 pt-20 pb-14">
          <p className="uppercase tracking-[0.18em] text-[13px] font-medium text-[#101010]/70">
            Insured yield for startups
          </p>
          <h1 className="mt-3 font-serif text-[88px] leading-[0.96] tracking-[-0.015em] text-[#101010]">
            <span className="block text-[#1B29FF] text-[108px] leading-[0.9]">
              10% Yield
            </span>{' '}
          ...
          <div className="mt-10 flex items-center gap-20">
            ...
            <Link
              className="text-[16px] text-[#101010] hover:text-[#1B29FF] underline decoration-[#101010]/30 underline-offset-[4px] hover:decoration-[#1B29FF] transition-colors"
              ...
              <div className="col-span-8 p-6 border-r border-[#101010]/10">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-1 tabular-nums text-[20px] font-medium text-[#1B29FF]">
                      $20,674.42
                    </div>
                  </div>
                </div>
      ...
      {/* How it works */}
      <section className="bg-[#F6F5EF] border-t border-[#101010]/10 py-16">
        <div className="mx-auto max-w-[1200px] px-8">
          ...
          <div className="mt-8 grid grid-cols-3 divide-x divide-[#101010]/10 border border-[#101010]/10 bg-white">
            <div className="p-6">
              <div className="text-[12px] uppercase tracking-[0.14em] text-[#101010]/60">
                1
              </div>
              <h3 className="mt-2 text-[16px] font-medium text-[#101010]">
                Deposit funds
              </h3>
              <p className="mt-1 text-[14px] text-[#101010]/70">
