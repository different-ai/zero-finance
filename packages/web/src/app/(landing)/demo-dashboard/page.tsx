          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Image
                ...
                className="mr-3"
              />
              <span className="text-xl font-semibold text-[#0050ff]">
              <span className="text-xl font-semibold text-[#0050ff]">finance</span><span className="text-xl font-semibold text-gray-900 ml-1">Demo</span>
              </span>
