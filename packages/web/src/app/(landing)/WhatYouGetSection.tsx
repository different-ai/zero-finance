...
export function WhatYouGetSection() {
  return (
    <section className="bg-[#F7F7F2] border-t border-[#101010]/10 py-16">
      <div className="mx-auto max-w-[1200px] px-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-px bg-[#101010]/10">
          <div className="bg-white p-6">
            ...
            <p className="mt-3 text-[14px] leading-[1.5] text-[#101010]/80">
              ...
              insurance from Munich Re. Your funds are protected while
