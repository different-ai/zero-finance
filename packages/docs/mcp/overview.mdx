...
- Propose bank and crypto transfers
- Manage savings positions
...
| `list_vaults`              | List yield vaults              |
| `propose_deposit`          | Propose a vault deposit        |
| `propose_withdrawal`       | Propose a vault withdrawal     |
| `get_positions`            | Get vault positions            |
...
2. **Write operations** — Transfers and withdrawals create proposals
3. **Human approval** — All outbound fund movements require dashboard approval
