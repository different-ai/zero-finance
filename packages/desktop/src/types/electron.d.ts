...
export interface ElectronAPI {
  ...
  addToCalendar: (params: { icsPath: string; content: string; event: { title: string; startTime: string; endTime: string; location: string; description: string; attendees: string[] } }) => Promise<void>
