...
export function InvoiceList() {
  ...
  const handleViewInvoice = async (requestId: string) => {
    try {
      // Generate ephemeral key for viewing
      const { publicKey, token } = await window.api.generateEphemeralKey();
      const url = await window.api.generateInvoiceUrl(requestId, token);
