...
description: "Use this agent when the user provides a startup name and needs you to research and document its latest fundraising information. Examples include researching funding rounds for companies like Anthropic, Runway AI, or Perplexity to add them to the companies tracking database."
mode: subagent
